class CCurrentWeatherData(object):
	...
	def CCurrentWeatherData_buf():
		...
		ATL::COleDateTime::COleDateTime(&thisa->_LastRainReset);
		...
		CCurrentWeatherData::read(thisa, buf);

		CCurrentWeatherData::read(thisa, buf);

	def read(self,buf):
		  USBHardware::ReverseByteOrder(buf, 2u);
		  CCurrentWeatherData::readAlarmFlags(thisa, buf, &thisa->_AlarmRingingFlags);
		  thisa->_WeatherState = buf[2] & 0xF;
		  thisa->_WeatherTendency = ((signed int)(unsigned __int8)buf[2] >> 4) & 0xF;
		  USBHardware::ReverseByteOrder(buf + 3, 0x12u);
		  v2 = USBHardware::ToTemperature(buf + 3, 1);
		  thisa->_IndoorTemp = v2;
		  v3 = USBHardware::ToTemperature(buf + 5, 0);
		  ...
		  USBHardware::ReverseByteOrder(buf + 21, 0x12u);
		  v9 = USBHardware::ToTemperature(buf + 21, 1);
		  thisa->_OutdoorTemp = v9;
		  ...
		  USBHardware::ReverseByteOrder(buf + 39, 0x12u);
		  ...
		  USBHardware::ReverseByteOrder(buf + 57, 0x12u);
  ...
  USBHardware::ReverseByteOrder(buf + 75, 0xDu);
