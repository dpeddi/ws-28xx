...
# Copyright (C) 2005,2006,2007,2010,2011  Timo Juhani Lindfors <timo.lindfors@iki.fi>
#
...
#
# You can get latest version of this program from the git repository
# http://iki.fi/lindi/git/usbsnoop2libusb.git
